...
public class Venda implements Serializable {
    ...
    @ManyToMany
    @JoinTable(name = "tb_venda_consulta", joinColumns = { @JoinColumn(name = "venda_id") }, // agregacao, vai gerar uma
                                                                                             // tabela associativa.
            inverseJoinColumns = { @JoinColumn(name = "consulta_id") })
    private List<Consulta> consultas;

    @ManyToMany
    @JoinTable(name = "tb_venda_produto", joinColumns = { @JoinColumn(name = "venda_id") }, // agregacao, vai gerar uma
                                                                                            // tabela associativa.
